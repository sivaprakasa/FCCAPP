...
function tableResize(selector) {
    ...
    function dragDropResize(e) {
        ...
        mousedown = true;
        currentX = e.pageX;
        currentWidth = currentCol[0].offsetWidth || parseInt(currentCol[0].style.width.substring(0, (currentCol[0].style.width.length) - 2)) || 200;    // 100 is default
        ...
        function mouseupevent() {
            if (mousedown) {
                ...
                // localStorage.TableResizeWidths = JSON.stringify(widths);   OLD
                $(document).ready(function () {
                    localStorage.removeItem('TableResizeWidths');
                })
            }
        };
